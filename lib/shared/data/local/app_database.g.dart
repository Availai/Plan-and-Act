...
class $VideoCandidatesTable extends VideoCandidates
    with TableInfo<$VideoCandidatesTable, VideoCandidate> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $VideoCandidatesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'video_candidates';
  @override
  VerificationContext validateIntegrity(
    Insertable<VideoCandidate> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  VideoCandidate map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $VideoCandidatesTable createAlias(String alias) {
    return $VideoCandidatesTable(attachedDatabase, alias);
  }
}

class VideoCandidate extends DataClass implements Insertable<VideoCandidate> {
  final String id;
  ...
  VideoCandidatesCompanion toCompanion(bool nullToAbsent) {
    return VideoCandidatesCompanion(
      id: Value(id),
  ...
  factory VideoCandidate.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  VideoCandidate copyWithCompanion(VideoCandidatesCompanion data) {
    return VideoCandidate(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('VideoCandidate(')
          ..write('id: $id, ')
...
class VideoCandidatesCompanion extends UpdateCompanion<VideoCandidate> {
  final Value<String> id;
  ...
  final Value<int> rowid;
  const VideoCandidatesCompanion({
    this.id = const Value.absent(),
  ...
  VideoCandidatesCompanion.insert({
    required String id,
    ...
    this.rowid = const Value.absent(),
       ...
       canonicalUrl = Value(canonicalUrl),
       fetchedAt = Value(fetchedAt);
  static Insertable<VideoCandidate> custom({
    Expression<String>? id,
  ...
  VideoCandidatesCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('VideoCandidatesCompanion(')
          ..write('id: $id, ')
          ..write('youtubeVideoId: $youtubeVideoId, ')
          ..write('title: $title, ')
          ..write('description: $description, ')
...
class $VideoTopicsTable extends VideoTopics
    with TableInfo<$VideoTopicsTable, VideoTopic> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $VideoTopicsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'video_topics';
  @override
  VerificationContext validateIntegrity(
    Insertable<VideoTopic> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  VideoTopic map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return VideoTopic(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $VideoTopicsTable createAlias(String alias) {
    return $VideoTopicsTable(attachedDatabase, alias);
  }
}

class VideoTopic extends DataClass implements Insertable<VideoTopic> {
  final String id;
  final String slug;
  final String name;
  final DateTime createdAt;
  ...
  VideoTopicsCompanion toCompanion(bool nullToAbsent) {
    return VideoTopicsCompanion(
      id: Value(id),
      slug: Value(slug),
      name: Value(name),
      createdAt: Value(createdAt),
  ...
  VideoTopic copyWithCompanion(VideoTopicsCompanion data) {
    return VideoTopic(
      id: data.id.present ? data.id.value : this.id,
      slug: data.slug.present ? data.slug.value : this.slug,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('VideoTopic(')
          ..write('id: $id, ')
          ..write('slug: $slug, ')
          ..write('name: $name, ')
          ..write('createdAt: $createdAt')
...
class VideoTopicsCompanion extends UpdateCompanion<VideoTopic> {
  final Value<String> id;
  final Value<String> slug;
  final Value<String> name;
  final Value<DateTime> createdAt;
  final Value<int> rowid;
  const VideoTopicsCompanion({
    this.id = const Value.absent(),
    this.slug = const Value.absent(),
    this.name = const Value.absent(),
    this.createdAt = const Value.absent(),
  ...
  VideoTopicsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       name = Value(name),
       createdAt = Value(createdAt);
  static Insertable<VideoTopic> custom({
    Expression<String>? id,
    Expression<String>? slug,
    Expression<String>? name,
    Expression<DateTime>? createdAt,
  ...
  @override
  String toString() {
    return (StringBuffer('VideoTopicsCompanion(')
          ..write('id: $id, ')
          ..write('slug: $slug, ')
          ..write('name: $name, ')
          ..write('createdAt: $createdAt, ')
...
class $VideoCandidateTopicsTable extends VideoCandidateTopics
    with TableInfo<$VideoCandidateTopicsTable, VideoCandidateTopic> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $VideoCandidateTopicsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _videoCandidateIdMeta = const VerificationMeta(
    'videoCandidateId',
  );
  @override
  late final GeneratedColumn<String> videoCandidateId = GeneratedColumn<String>(
    'video_candidate_id',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  List<GeneratedColumn> get $columns => [videoCandidateId, topicId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'video_candidate_topics';
  @override
  VerificationContext validateIntegrity(
    Insertable<VideoCandidateTopic> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('video_candidate_id')) {
      context.handle(
        _videoCandidateIdMeta,
        videoCandidateId.isAcceptableOrUnknown(
          data['video_candidate_id']!,
          _videoCandidateIdMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_videoCandidateIdMeta);
    }
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {videoCandidateId, topicId};
  @override
  VideoCandidateTopic map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return VideoCandidateTopic(
      videoCandidateId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}video_candidate_id'],
      )!,
  ...
  @override
  $VideoCandidateTopicsTable createAlias(String alias) {
    return $VideoCandidateTopicsTable(attachedDatabase, alias);
  }
}

class VideoCandidateTopic extends DataClass
    implements Insertable<VideoCandidateTopic> {
  final String videoCandidateId;
  final String topicId;
  const VideoCandidateTopic({
    required this.videoCandidateId,
    required this.topicId,
  });
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['video_candidate_id'] = Variable<String>(videoCandidateId);
    map['topic_id'] = Variable<String>(topicId);
    return map;
  }

  VideoCandidateTopicsCompanion toCompanion(bool nullToAbsent) {
    return VideoCandidateTopicsCompanion(
      videoCandidateId: Value(videoCandidateId),
      topicId: Value(topicId),
    );
  }

  factory VideoCandidateTopic.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return VideoCandidateTopic(
      videoCandidateId: serializer.fromJson<String>(json['videoCandidateId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return <String, dynamic>{
      'videoCandidateId': serializer.toJson<String>(videoCandidateId),
      'topicId': serializer.toJson<String>(topicId),
    };
  }

  VideoCandidateTopic copyWith({String? videoCandidateId, String? topicId}) =>
      VideoCandidateTopic(
        videoCandidateId: videoCandidateId ?? this.videoCandidateId,
        topicId: topicId ?? this.topicId,
      );
  VideoCandidateTopic copyWithCompanion(VideoCandidateTopicsCompanion data) {
    return VideoCandidateTopic(
      videoCandidateId: data.videoCandidateId.present
          ? data.videoCandidateId.value
          : this.videoCandidateId,
  ...
  @override
  String toString() {
    return (StringBuffer('VideoCandidateTopic(')
          ..write('videoCandidateId: $videoCandidateId, ')
  ...
  @override
  int get hashCode => Object.hash(videoCandidateId, topicId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is VideoCandidateTopic &&
          other.videoCandidateId == this.videoCandidateId &&
          other.topicId == this.topicId);
}

class VideoCandidateTopicsCompanion
    extends UpdateCompanion<VideoCandidateTopic> {
  final Value<String> videoCandidateId;
  final Value<String> topicId;
  final Value<int> rowid;
  const VideoCandidateTopicsCompanion({
    this.videoCandidateId = const Value.absent(),
    this.topicId = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  VideoCandidateTopicsCompanion.insert({
    required String videoCandidateId,
    required String topicId,
    this.rowid = const Value.absent(),
  }) : videoCandidateId = Value(videoCandidateId),
       topicId = Value(topicId);
  static Insertable<VideoCandidateTopic> custom({
    Expression<String>? videoCandidateId,
    Expression<String>? topicId,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (videoCandidateId != null) 'video_candidate_id': videoCandidateId,
      if (topicId != null) 'topic_id': topicId,
      if (rowid != null) 'rowid': rowid,
    });
  }

  VideoCandidateTopicsCompanion copyWith({
    Value<String>? videoCandidateId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (videoCandidateId.present) {
      map['video_candidate_id'] = Variable<String>(videoCandidateId.value);
    }
    if (topicId.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('VideoCandidateTopicsCompanion(')
          ..write('videoCandidateId: $videoCandidateId, ')
          ..write('topicId: $topicId, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
class $DailyVideoSelectionsTable extends DailyVideoSelections
    with TableInfo<$DailyVideoSelectionsTable, DailyVideoSelection> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $DailyVideoSelectionsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  static const VerificationMeta _selectionDateMeta = const VerificationMeta(
    'selectionDate',
  );
  @override
  late final GeneratedColumn<DateTime> selectionDate =
      GeneratedColumn<DateTime>(
        'selection_date',
        aliasedName,
        false,
  ...
  static const VerificationMeta _selectionReasonMeta = const VerificationMeta(
    'selectionReason',
  );
  @override
  late final GeneratedColumn<String> selectionReason = GeneratedColumn<String>(
    'selection_reason',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'daily_video_selections';
  @override
  VerificationContext validateIntegrity(
    Insertable<DailyVideoSelection> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('selection_date')) {
      context.handle(
        _selectionDateMeta,
        selectionDate.isAcceptableOrUnknown(
          data['selection_date']!,
          _selectionDateMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_selectionDateMeta);
    }
    if (data.containsKey('topic_id')) {
      context.handle(
        _topicIdMeta,
    ...
    if (data.containsKey('selection_reason')) {
      context.handle(
        _selectionReasonMeta,
        selectionReason.isAcceptableOrUnknown(
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  DailyVideoSelection map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DailyVideoSelection(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
      selectionDate: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}selection_date'],
      )!,
      topicId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}topic_id'],
      ...
      selectionReason: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}selection_reason'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
  ...
  @override
  $DailyVideoSelectionsTable createAlias(String alias) {
    return $DailyVideoSelectionsTable(attachedDatabase, alias);
  }
}

class DailyVideoSelection extends DataClass
    implements Insertable<DailyVideoSelection> {
  final String id;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<String>(id);
    map['selection_date'] = Variable<DateTime>(selectionDate);
    map['topic_id'] = Variable<String>(topicId);
    map['video_candidate_id'] = Variable<String>(videoCandidateId);
    if (!nullToAbsent || selectionReason != null) {
      map['selection_reason'] = Variable<String>(selectionReason);
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    return map;
  }

  DailyVideoSelectionsCompanion toCompanion(bool nullToAbsent) {
    return DailyVideoSelectionsCompanion(
      id: Value(id),
      selectionDate: Value(selectionDate),
      topicId: Value(topicId),
      videoCandidateId: Value(videoCandidateId),
      selectionReason: selectionReason == null && nullToAbsent
          ? const Value.absent()
  ...
  factory DailyVideoSelection.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DailyVideoSelection(
      id: serializer.fromJson<String>(json['id']),
      selectionDate: serializer.fromJson<DateTime>(json['selectionDate']),
      topicId: serializer.fromJson<String>(json['topicId']),
      videoCandidateId: serializer.fromJson<String>(json['videoCandidateId']),
      selectionReason: serializer.fromJson<String?>(json['selectionReason']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<String>(id),
      'selectionDate': serializer.toJson<DateTime>(selectionDate),
      'topicId': serializer.toJson<String>(topicId),
      'videoCandidateId': serializer.toJson<String>(videoCandidateId),
      'selectionReason': serializer.toJson<String?>(selectionReason),
      'createdAt': serializer.toJson<DateTime>(createdAt),
    };
  }

  DailyVideoSelection copyWith({
    String? id,
    DateTime? selectionDate,
    String? topicId,
    String? videoCandidateId,
    Value<String?> selectionReason = const Value.absent(),
    DateTime? createdAt,
  }) => DailyVideoSelection(
    id: id ?? this.id,
    ...
    topicId: topicId ?? this.topicId,
    videoCandidateId: videoCandidateId ?? this.videoCandidateId,
    selectionReason: selectionReason.present
        ? selectionReason.value
        : this.selectionReason,
    createdAt: createdAt ?? this.createdAt,
  );
  DailyVideoSelection copyWithCompanion(DailyVideoSelectionsCompanion data) {
    return DailyVideoSelection(
      id: data.id.present ? data.id.value : this.id,
      selectionDate: data.selectionDate.present
          ? data.selectionDate.value
          : this.selectionDate,
      topicId: data.topicId.present ? data.topicId.value : this.topicId,
      videoCandidateId: data.videoCandidateId.present
          ? data.videoCandidateId.value
          : this.videoCandidateId,
      selectionReason: data.selectionReason.present
          ? data.selectionReason.value
          : this.selectionReason,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('DailyVideoSelection(')
          ..write('id: $id, ')
          ..write('selectionDate: $selectionDate, ')
          ..write('topicId: $topicId, ')
          ..write('videoCandidateId: $videoCandidateId, ')
          ..write('selectionReason: $selectionReason, ')
          ..write('createdAt: $createdAt')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DailyVideoSelection &&
          other.id == this.id &&
          other.selectionDate == this.selectionDate &&
          other.topicId == this.topicId &&
          other.videoCandidateId == this.videoCandidateId &&
          other.selectionReason == this.selectionReason &&
          other.createdAt == this.createdAt);
}

class DailyVideoSelectionsCompanion
    extends UpdateCompanion<DailyVideoSelection> {
  final Value<String> id;
  final Value<DateTime> selectionDate;
  final Value<String> topicId;
  final Value<String> videoCandidateId;
  final Value<String?> selectionReason;
  final Value<DateTime> createdAt;
  final Value<int> rowid;
  const DailyVideoSelectionsCompanion({
    this.id = const Value.absent(),
    this.selectionDate = const Value.absent(),
    this.topicId = const Value.absent(),
    this.videoCandidateId = const Value.absent(),
    this.selectionReason = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  DailyVideoSelectionsCompanion.insert({
    required String id,
    required DateTime selectionDate,
    required String topicId,
    required String videoCandidateId,
    this.selectionReason = const Value.absent(),
    required DateTime createdAt,
    this.rowid = const Value.absent(),
       ...
       videoCandidateId = Value(videoCandidateId),
       createdAt = Value(createdAt);
  static Insertable<DailyVideoSelection> custom({
    Expression<String>? id,
    Expression<DateTime>? selectionDate,
    Expression<String>? topicId,
    Expression<String>? videoCandidateId,
    Expression<String>? selectionReason,
    Expression<DateTime>? createdAt,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (selectionDate != null) 'selection_date': selectionDate,
      if (topicId != null) 'topic_id': topicId,
      if (videoCandidateId != null) 'video_candidate_id': videoCandidateId,
  ...
  DailyVideoSelectionsCompanion copyWith({
    Value<String>? id,
    Value<DateTime>? selectionDate,
    Value<String>? topicId,
    Value<String>? videoCandidateId,
    Value<String?>? selectionReason,
    Value<DateTime>? createdAt,
    Value<int>? rowid,
  }) {
    return DailyVideoSelectionsCompanion(
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (selectionDate.present) {
      map['selection_date'] = Variable<DateTime>(selectionDate.value);
    }
    if (topicId.present) {
      map['topic_id'] = Variable<String>(topicId.value);
    }
    ...
    if (selectionReason.present) {
      map['selection_reason'] = Variable<String>(selectionReason.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('DailyVideoSelectionsCompanion(')
          ..write('id: $id, ')
          ..write('selectionDate: $selectionDate, ')
          ..write('topicId: $topicId, ')
          ..write('videoCandidateId: $videoCandidateId, ')
...
class $VideoImpressionsTable extends VideoImpressions
    with TableInfo<$VideoImpressionsTable, VideoImpression> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $VideoImpressionsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  static const VerificationMeta _dailyVideoSelectionIdMeta =
      const VerificationMeta('dailyVideoSelectionId');
  @override
  late final GeneratedColumn<String> dailyVideoSelectionId =
      GeneratedColumn<String>(
        'daily_video_selection_id',
        aliasedName,
        false,
        type: DriftSqlType.string,
        requiredDuringInsert: true,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'video_impressions';
  @override
  VerificationContext validateIntegrity(
    Insertable<VideoImpression> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('daily_video_selection_id')) {
      context.handle(
        _dailyVideoSelectionIdMeta,
        dailyVideoSelectionId.isAcceptableOrUnknown(
          data['daily_video_selection_id']!,
          _dailyVideoSelectionIdMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_dailyVideoSelectionIdMeta);
    }
    if (data.containsKey('video_candidate_id')) {
      context.handle(
        _videoCandidateIdMeta,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  VideoImpression map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return VideoImpression(
      ...
      dailyVideoSelectionId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}daily_video_selection_id'],
      )!,
      videoCandidateId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}video_candidate_id'],
  ...
  @override
  $VideoImpressionsTable createAlias(String alias) {
    return $VideoImpressionsTable(attachedDatabase, alias);
  }
}

class VideoImpression extends DataClass implements Insertable<VideoImpression> {
  final String id;
  final String userId;
  final String dailyVideoSelectionId;
  final String videoCandidateId;
  final String eventType;
  final DateTime createdAt;
  const VideoImpression({
    required this.id,
    required this.userId,
    required this.dailyVideoSelectionId,
    required this.videoCandidateId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<String>(id);
    map['user_id'] = Variable<String>(userId);
    map['daily_video_selection_id'] = Variable<String>(dailyVideoSelectionId);
    map['video_candidate_id'] = Variable<String>(videoCandidateId);
  ...
  VideoImpressionsCompanion toCompanion(bool nullToAbsent) {
    return VideoImpressionsCompanion(
      id: Value(id),
      userId: Value(userId),
      dailyVideoSelectionId: Value(dailyVideoSelectionId),
      videoCandidateId: Value(videoCandidateId),
  ...
  factory VideoImpression.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return VideoImpression(
      id: serializer.fromJson<String>(json['id']),
      userId: serializer.fromJson<String>(json['userId']),
      dailyVideoSelectionId: serializer.fromJson<String>(
        json['dailyVideoSelectionId'],
      ),
      videoCandidateId: serializer.fromJson<String>(json['videoCandidateId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<String>(id),
      'userId': serializer.toJson<String>(userId),
      'dailyVideoSelectionId': serializer.toJson<String>(dailyVideoSelectionId),
      'videoCandidateId': serializer.toJson<String>(videoCandidateId),
  ...
  VideoImpression copyWith({
    String? id,
    String? userId,
    String? dailyVideoSelectionId,
    String? videoCandidateId,
    String? eventType,
    DateTime? createdAt,
  }) => VideoImpression(
    id: id ?? this.id,
    userId: userId ?? this.userId,
    dailyVideoSelectionId: dailyVideoSelectionId ?? this.dailyVideoSelectionId,
    videoCandidateId: videoCandidateId ?? this.videoCandidateId,
    eventType: eventType ?? this.eventType,
    createdAt: createdAt ?? this.createdAt,
  );
  VideoImpression copyWithCompanion(VideoImpressionsCompanion data) {
    return VideoImpression(
      id: data.id.present ? data.id.value : this.id,
      userId: data.userId.present ? data.userId.value : this.userId,
      dailyVideoSelectionId: data.dailyVideoSelectionId.present
          ? data.dailyVideoSelectionId.value
          : this.dailyVideoSelectionId,
      videoCandidateId: data.videoCandidateId.present
          ? data.videoCandidateId.value
          : this.videoCandidateId,
  ...
  @override
  String toString() {
    return (StringBuffer('VideoImpression(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('dailyVideoSelectionId: $dailyVideoSelectionId, ')
          ..write('videoCandidateId: $videoCandidateId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is VideoImpression &&
          other.id == this.id &&
          other.userId == this.userId &&
          other.dailyVideoSelectionId == this.dailyVideoSelectionId &&
          other.videoCandidateId == this.videoCandidateId &&
          other.eventType == this.eventType &&
          other.createdAt == this.createdAt);
}

class VideoImpressionsCompanion extends UpdateCompanion<VideoImpression> {
  final Value<String> id;
  final Value<String> userId;
  final Value<String> dailyVideoSelectionId;
  final Value<String> videoCandidateId;
  final Value<String> eventType;
  final Value<DateTime> createdAt;
  final Value<int> rowid;
  const VideoImpressionsCompanion({
    this.id = const Value.absent(),
    this.userId = const Value.absent(),
    this.dailyVideoSelectionId = const Value.absent(),
    this.videoCandidateId = const Value.absent(),
  ...
  VideoImpressionsCompanion.insert({
    required String id,
    required String userId,
    required String dailyVideoSelectionId,
    required String videoCandidateId,
    ...
    this.rowid = const Value.absent(),
       ...
       eventType = Value(eventType),
       createdAt = Value(createdAt);
  static Insertable<VideoImpression> custom({
    Expression<String>? id,
    Expression<String>? userId,
    Expression<String>? dailyVideoSelectionId,
    Expression<String>? videoCandidateId,
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (userId != null) 'user_id': userId,
      if (dailyVideoSelectionId != null)
        'daily_video_selection_id': dailyVideoSelectionId,
      if (videoCandidateId != null) 'video_candidate_id': videoCandidateId,
  ...
  VideoImpressionsCompanion copyWith({
    Value<String>? id,
    Value<String>? userId,
    Value<String>? dailyVideoSelectionId,
    Value<String>? videoCandidateId,
    ...
    return VideoImpressionsCompanion(
      ...
      userId: userId ?? this.userId,
      dailyVideoSelectionId:
          dailyVideoSelectionId ?? this.dailyVideoSelectionId,
      videoCandidateId: videoCandidateId ?? this.videoCandidateId,
      eventType: eventType ?? this.eventType,
      createdAt: createdAt ?? this.createdAt,
      rowid: rowid ?? this.rowid,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (dailyVideoSelectionId.present) {
      map['daily_video_selection_id'] = Variable<String>(
        dailyVideoSelectionId.value,
      );
    }
    if (videoCandidateId.present) {
      map['video_candidate_id'] = Variable<String>(videoCandidateId.value);
  ...
  @override
  String toString() {
    return (StringBuffer('VideoImpressionsCompanion(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('dailyVideoSelectionId: $dailyVideoSelectionId, ')
          ..write('videoCandidateId: $videoCandidateId, ')
...
class $DailyVideoCacheTable extends DailyVideoCache
    with TableInfo<$DailyVideoCacheTable, DailyVideoCacheData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $DailyVideoCacheTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'daily_video_cache';
  @override
  VerificationContext validateIntegrity(
    Insertable<DailyVideoCacheData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  DailyVideoCacheData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DailyVideoCacheData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $DailyVideoCacheTable createAlias(String alias) {
    return $DailyVideoCacheTable(attachedDatabase, alias);
  }
}

class DailyVideoCacheData extends DataClass
    implements Insertable<DailyVideoCacheData> {
  final String id;
  final DateTime cacheDate;
  final String videoCandidateId;
  final String metadataJson;
  final DateTime cachedAt;
  const DailyVideoCacheData({
    required this.id,
  ...
  DailyVideoCacheCompanion toCompanion(bool nullToAbsent) {
    return DailyVideoCacheCompanion(
      id: Value(id),
  ...
  factory DailyVideoCacheData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  DailyVideoCacheData copyWithCompanion(DailyVideoCacheCompanion data) {
    return DailyVideoCacheData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('DailyVideoCacheData(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, cacheDate, videoCandidateId, metadataJson, cachedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DailyVideoCacheData &&
          other.id == this.id &&
...
class DailyVideoCacheCompanion extends UpdateCompanion<DailyVideoCacheData> {
  final Value<String> id;
  ...
  final Value<int> rowid;
  const DailyVideoCacheCompanion({
    this.id = const Value.absent(),
  ...
  DailyVideoCacheCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       metadataJson = Value(metadataJson),
       cachedAt = Value(cachedAt);
  static Insertable<DailyVideoCacheData> custom({
    Expression<String>? id,
  ...
  DailyVideoCacheCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('DailyVideoCacheCompanion(')
          ..write('id: $id, ')
          ..write('cacheDate: $cacheDate, ')
          ..write('videoCandidateId: $videoCandidateId, ')
          ..write('metadataJson: $metadataJson, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $VideoCandidatesTable videoCandidates = $VideoCandidatesTable(
    this,
  );
  late final $VideoTopicsTable videoTopics = $VideoTopicsTable(this);
  late final $VideoCandidateTopicsTable videoCandidateTopics =
      $VideoCandidateTopicsTable(this);
  late final $DailyVideoSelectionsTable dailyVideoSelections =
      $DailyVideoSelectionsTable(this);
  late final $VideoImpressionsTable videoImpressions = $VideoImpressionsTable(
    this,
  );
  late final $DailyVideoCacheTable dailyVideoCache = $DailyVideoCacheTable(
    this,
  );
...
typedef $$DecisionLogCandidatesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$VideoCandidatesTableCreateCompanionBuilder =
    VideoCandidatesCompanion Function({
      required String id,
      required String youtubeVideoId,
      required String title,
      Value<String> description,
...
typedef $$VideoCandidatesTableUpdateCompanionBuilder =
    VideoCandidatesCompanion Function({
      Value<String> id,
      Value<String> youtubeVideoId,
      Value<String> title,
...
class $$VideoCandidatesTableFilterComposer
    extends Composer<_$AppDatabase, $VideoCandidatesTable> {
  $$VideoCandidatesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$VideoCandidatesTableOrderingComposer
    extends Composer<_$AppDatabase, $VideoCandidatesTable> {
  $$VideoCandidatesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$VideoCandidatesTableAnnotationComposer
    extends Composer<_$AppDatabase, $VideoCandidatesTable> {
  $$VideoCandidatesTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$VideoCandidatesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $VideoCandidatesTable,
          VideoCandidate,
          $$VideoCandidatesTableFilterComposer,
          $$VideoCandidatesTableOrderingComposer,
          $$VideoCandidatesTableAnnotationComposer,
          $$VideoCandidatesTableCreateCompanionBuilder,
          $$VideoCandidatesTableUpdateCompanionBuilder,
          (
            VideoCandidate,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$VideoCandidatesTableTableManager(
    _$AppDatabase db,
    $VideoCandidatesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$VideoCandidatesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$VideoCandidatesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$VideoCandidatesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
...
typedef $$VideoCandidatesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $VideoCandidatesTable,
      VideoCandidate,
      ...
      (
        VideoCandidate,
        BaseReferences<_$AppDatabase, $VideoCandidatesTable, VideoCandidate>,
      ),
      VideoCandidate,
      PrefetchHooks Function()
    >;
typedef $$VideoTopicsTableCreateCompanionBuilder =
    VideoTopicsCompanion Function({
      required String id,
      required String slug,
      required String name,
      required DateTime createdAt,
...
typedef $$VideoTopicsTableUpdateCompanionBuilder =
    VideoTopicsCompanion Function({
      Value<String> id,
      Value<String> slug,
      Value<String> name,
...
class $$VideoTopicsTableFilterComposer
    extends Composer<_$AppDatabase, $VideoTopicsTable> {
  $$VideoTopicsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$VideoTopicsTableOrderingComposer
    extends Composer<_$AppDatabase, $VideoTopicsTable> {
  $$VideoTopicsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$VideoTopicsTableAnnotationComposer
    extends Composer<_$AppDatabase, $VideoTopicsTable> {
  $$VideoTopicsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$VideoTopicsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $VideoTopicsTable,
          ...
          $$VideoTopicsTableOrderingComposer,
          $$VideoTopicsTableAnnotationComposer,
          $$VideoTopicsTableCreateCompanionBuilder,
          $$VideoTopicsTableUpdateCompanionBuilder,
          (
            VideoTopic,
            BaseReferences<_$AppDatabase, $VideoTopicsTable, VideoTopic>,
          ),
          VideoTopic,
          PrefetchHooks Function()
        > {
  $$VideoTopicsTableTableManager(_$AppDatabase db, $VideoTopicsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$VideoTopicsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$VideoTopicsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$VideoTopicsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> slug = const Value.absent(),
...
typedef $$VideoTopicsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $VideoTopicsTable,
      VideoTopic,
      ...
      PrefetchHooks Function()
    >;
typedef $$VideoCandidateTopicsTableCreateCompanionBuilder =
    VideoCandidateTopicsCompanion Function({
      required String videoCandidateId,
      required String topicId,
      Value<int> rowid,
    });
typedef $$VideoCandidateTopicsTableUpdateCompanionBuilder =
    VideoCandidateTopicsCompanion Function({
      Value<String> videoCandidateId,
      Value<String> topicId,
      Value<int> rowid,
...
class $$VideoCandidateTopicsTableFilterComposer
    extends Composer<_$AppDatabase, $VideoCandidateTopicsTable> {
  $$VideoCandidateTopicsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get videoCandidateId => $composableBuilder(
    column: $table.videoCandidateId,
    builder: (column) => ColumnFilters(column),
  );
...
class $$VideoCandidateTopicsTableOrderingComposer
    extends Composer<_$AppDatabase, $VideoCandidateTopicsTable> {
  $$VideoCandidateTopicsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get videoCandidateId => $composableBuilder(
    column: $table.videoCandidateId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$VideoCandidateTopicsTableAnnotationComposer
    extends Composer<_$AppDatabase, $VideoCandidateTopicsTable> {
  $$VideoCandidateTopicsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get videoCandidateId => $composableBuilder(
    column: $table.videoCandidateId,
    builder: (column) => column,
  );
...
class $$VideoCandidateTopicsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $VideoCandidateTopicsTable,
          VideoCandidateTopic,
          $$VideoCandidateTopicsTableFilterComposer,
          $$VideoCandidateTopicsTableOrderingComposer,
          $$VideoCandidateTopicsTableAnnotationComposer,
          $$VideoCandidateTopicsTableCreateCompanionBuilder,
          $$VideoCandidateTopicsTableUpdateCompanionBuilder,
          (
            VideoCandidateTopic,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$VideoCandidateTopicsTableTableManager(
    _$AppDatabase db,
    $VideoCandidateTopicsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$VideoCandidateTopicsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$VideoCandidateTopicsTableOrderingComposer(
                $db: db,
                $table: table,
          ...
          updateCompanionCallback:
              ({
                Value<String> videoCandidateId = const Value.absent(),
                Value<String> topicId = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => VideoCandidateTopicsCompanion(
...
typedef $$VideoCandidateTopicsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $VideoCandidateTopicsTable,
      VideoCandidateTopic,
      ...
      PrefetchHooks Function()
    >;
typedef $$DailyVideoSelectionsTableCreateCompanionBuilder =
    DailyVideoSelectionsCompanion Function({
      required String id,
      required DateTime selectionDate,
      required String topicId,
      required String videoCandidateId,
...
typedef $$DailyVideoSelectionsTableUpdateCompanionBuilder =
    DailyVideoSelectionsCompanion Function({
      Value<String> id,
      Value<DateTime> selectionDate,
      Value<String> topicId,
...
class $$DailyVideoSelectionsTableFilterComposer
    extends Composer<_$AppDatabase, $DailyVideoSelectionsTable> {
  $$DailyVideoSelectionsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<DateTime> get selectionDate => $composableBuilder(
    column: $table.selectionDate,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<String> get selectionReason => $composableBuilder(
    column: $table.selectionReason,
    builder: (column) => ColumnFilters(column),
  );
...
class $$DailyVideoSelectionsTableOrderingComposer
    extends Composer<_$AppDatabase, $DailyVideoSelectionsTable> {
  $$DailyVideoSelectionsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<DateTime> get selectionDate => $composableBuilder(
    column: $table.selectionDate,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<String> get selectionReason => $composableBuilder(
    column: $table.selectionReason,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$DailyVideoSelectionsTableAnnotationComposer
    extends Composer<_$AppDatabase, $DailyVideoSelectionsTable> {
  $$DailyVideoSelectionsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<DateTime> get selectionDate => $composableBuilder(
    column: $table.selectionDate,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<String> get selectionReason => $composableBuilder(
    column: $table.selectionReason,
    builder: (column) => column,
  );
...
class $$DailyVideoSelectionsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $DailyVideoSelectionsTable,
          DailyVideoSelection,
          $$DailyVideoSelectionsTableFilterComposer,
          $$DailyVideoSelectionsTableOrderingComposer,
          $$DailyVideoSelectionsTableAnnotationComposer,
          $$DailyVideoSelectionsTableCreateCompanionBuilder,
          $$DailyVideoSelectionsTableUpdateCompanionBuilder,
          (
            DailyVideoSelection,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$DailyVideoSelectionsTableTableManager(
    _$AppDatabase db,
    $DailyVideoSelectionsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$DailyVideoSelectionsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$DailyVideoSelectionsTableOrderingComposer(
                $db: db,
                $table: table,
          ...
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<DateTime> selectionDate = const Value.absent(),
                Value<String> topicId = const Value.absent(),
                Value<String> videoCandidateId = const Value.absent(),
                Value<String?> selectionReason = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => DailyVideoSelectionsCompanion(
                id: id,
...
typedef $$DailyVideoSelectionsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $DailyVideoSelectionsTable,
      DailyVideoSelection,
      ...
      PrefetchHooks Function()
    >;
typedef $$VideoImpressionsTableCreateCompanionBuilder =
    VideoImpressionsCompanion Function({
      required String id,
      required String userId,
      required String dailyVideoSelectionId,
      required String videoCandidateId,
...
typedef $$VideoImpressionsTableUpdateCompanionBuilder =
    VideoImpressionsCompanion Function({
      Value<String> id,
      Value<String> userId,
      Value<String> dailyVideoSelectionId,
...
class $$VideoImpressionsTableFilterComposer
    extends Composer<_$AppDatabase, $VideoImpressionsTable> {
  $$VideoImpressionsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get dailyVideoSelectionId => $composableBuilder(
    column: $table.dailyVideoSelectionId,
    builder: (column) => ColumnFilters(column),
  );
...
class $$VideoImpressionsTableOrderingComposer
    extends Composer<_$AppDatabase, $VideoImpressionsTable> {
  $$VideoImpressionsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get dailyVideoSelectionId => $composableBuilder(
    column: $table.dailyVideoSelectionId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$VideoImpressionsTableAnnotationComposer
    extends Composer<_$AppDatabase, $VideoImpressionsTable> {
  $$VideoImpressionsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get dailyVideoSelectionId => $composableBuilder(
    column: $table.dailyVideoSelectionId,
    builder: (column) => column,
  );
...
class $$VideoImpressionsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $VideoImpressionsTable,
          VideoImpression,
          $$VideoImpressionsTableFilterComposer,
          $$VideoImpressionsTableOrderingComposer,
          $$VideoImpressionsTableAnnotationComposer,
          $$VideoImpressionsTableCreateCompanionBuilder,
          $$VideoImpressionsTableUpdateCompanionBuilder,
          (
            VideoImpression,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$VideoImpressionsTableTableManager(
    _$AppDatabase db,
    $VideoImpressionsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$VideoImpressionsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$VideoImpressionsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$VideoImpressionsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> userId = const Value.absent(),
                Value<String> dailyVideoSelectionId = const Value.absent(),
                Value<String> videoCandidateId = const Value.absent(),
                Value<String> eventType = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => VideoImpressionsCompanion(
                id: id,
                userId: userId,
                dailyVideoSelectionId: dailyVideoSelectionId,
                videoCandidateId: videoCandidateId,
                eventType: eventType,
                createdAt: createdAt,
                rowid: rowid,
...
typedef $$VideoImpressionsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $VideoImpressionsTable,
      VideoImpression,
      ...
      (
        VideoImpression,
        BaseReferences<_$AppDatabase, $VideoImpressionsTable, VideoImpression>,
      ),
      VideoImpression,
      PrefetchHooks Function()
    >;
typedef $$DailyVideoCacheTableCreateCompanionBuilder =
    DailyVideoCacheCompanion Function({
      required String id,
      required DateTime cacheDate,
      required String videoCandidateId,
      required String metadataJson,
...
typedef $$DailyVideoCacheTableUpdateCompanionBuilder =
    DailyVideoCacheCompanion Function({
      Value<String> id,
      Value<DateTime> cacheDate,
      Value<String> videoCandidateId,
...
class $$DailyVideoCacheTableFilterComposer
    extends Composer<_$AppDatabase, $DailyVideoCacheTable> {
  $$DailyVideoCacheTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DailyVideoCacheTableOrderingComposer
    extends Composer<_$AppDatabase, $DailyVideoCacheTable> {
  $$DailyVideoCacheTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DailyVideoCacheTableAnnotationComposer
    extends Composer<_$AppDatabase, $DailyVideoCacheTable> {
  $$DailyVideoCacheTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DailyVideoCacheTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $DailyVideoCacheTable,
          DailyVideoCacheData,
          $$DailyVideoCacheTableFilterComposer,
          $$DailyVideoCacheTableOrderingComposer,
          $$DailyVideoCacheTableAnnotationComposer,
          $$DailyVideoCacheTableCreateCompanionBuilder,
          $$DailyVideoCacheTableUpdateCompanionBuilder,
          (
            DailyVideoCacheData,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$DailyVideoCacheTableTableManager(
    _$AppDatabase db,
    $DailyVideoCacheTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$DailyVideoCacheTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$DailyVideoCacheTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$DailyVideoCacheTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
...
typedef $$DailyVideoCacheTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $DailyVideoCacheTable,
      DailyVideoCacheData,
...
class $AppDatabaseManager {
  ...
  $$VideoCandidatesTableTableManager get videoCandidates =>
      $$VideoCandidatesTableTableManager(_db, _db.videoCandidates);
  $$VideoTopicsTableTableManager get videoTopics =>
      $$VideoTopicsTableTableManager(_db, _db.videoTopics);
  $$VideoCandidateTopicsTableTableManager get videoCandidateTopics =>
      $$VideoCandidateTopicsTableTableManager(_db, _db.videoCandidateTopics);
  $$DailyVideoSelectionsTableTableManager get dailyVideoSelections =>
      $$DailyVideoSelectionsTableTableManager(_db, _db.dailyVideoSelections);
  $$VideoImpressionsTableTableManager get videoImpressions =>
      $$VideoImpressionsTableTableManager(_db, _db.videoImpressions);
  $$DailyVideoCacheTableTableManager get dailyVideoCache =>
      $$DailyVideoCacheTableTableManager(_db, _db.dailyVideoCache);
